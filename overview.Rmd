...
If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/paciorek/lbl-workshop-2019/archive/master.zip](https://github.com/paciorek/lbl-workshop-2019/archive/master.zip).
